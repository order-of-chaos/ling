...
function initI18nModule(namespace) {
  const useI18n = () => {
    ...
    const noun2 = useMemo2(() => createNoun(language), [language]);
    return {
      t,
      noun: noun2,
      language,
...
import {
  ...
  LangMap,
  LangNames,
  createLocalStorage as createLocalStorage2,
  createMemoryStorage,
  noun,
  createNoun as createNoun2
} from "@orderofchaos/ling-core";
export {
  I18nProvider,
  Lang,
  LangMap,
  LangNames,
  createLocalStorage2 as createLocalStorage,
  createMemoryStorage,
  createNoun2 as createNoun,
  initI18nModule,
  noun,
  useI18nContext
};
