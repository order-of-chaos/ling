...
__export(index_exports, {
  ...
  Lang: () => import_ling_core3.Lang,
  LangMap: () => import_ling_core3.LangMap,
  LangNames: () => import_ling_core3.LangNames,
  createLocalStorage: () => import_ling_core3.createLocalStorage,
  createMemoryStorage: () => import_ling_core3.createMemoryStorage,
  createNoun: () => import_ling_core3.createNoun,
  initI18nModule: () => initI18nModule,
  noun: () => import_ling_core3.noun,
...
function initI18nModule(namespace) {
  const useI18n = () => {
    ...
    const noun2 = (0, import_react3.useMemo)(() => (0, import_ling_core2.createNoun)(language), [language]);
    return {
      t,
      noun: noun2,
      language,
...
// src/index.ts
var import_ling_core3 = require("@orderofchaos/ling-core");
