declare const LocalStorageLangKey = "MA_lang";
/**
 ...
 */
declare const LangNames: Record<string, string>;
/**
 * @deprecated Use LangNames instead.
 */
declare const LangMap: Record<string, string>;
...
export { type DefaultLang, type I18nStorage, Lang, LangMap, LangNames, LocalStorageLangKey, type LocalStorageOptions, type PluralCategory, type PluralForms, type TranslateFunction, type Translations, type TranslatorOptions, createLocalStorage, createMemoryStorage, createNoun, createTranslator, noun };
